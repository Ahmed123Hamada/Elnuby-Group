...
import { ArrowRight, MapPin, Ruler, User, Calendar } from 'lucide-react';
...
const ProjectsSection: React.FC = () => {
  ...
  // Get the first 3 projects from the actual data
      ...
      <div className="container-custom">
        ...
        >
          <Link
            ...
            to="/projects"
            className="inline-flex items-center px-8 py-4 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            {t('viewAllProjects')}
